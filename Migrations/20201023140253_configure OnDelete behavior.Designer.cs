...
namespace EmployeeAppApi.Migrations
{
    ...
    [Migration("20201023140253_configure OnDelete behavior")]
    partial class configureOnDeletebehavior
    {
            ...
            modelBuilder.Entity("EmployeeAppApi.Models.Employee", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateOfJoining = new DateTime(2020, 10, 23, 16, 2, 53, 467, DateTimeKind.Local).AddTicks(6439),
                        ...
                        new
                        {
                            ...
                            DateOfJoining = new DateTime(2020, 10, 23, 16, 2, 53, 471, DateTimeKind.Local).AddTicks(7),
                        ...
                        new
                        {
                            ...
                            DateOfJoining = new DateTime(2020, 10, 23, 16, 2, 53, 471, DateTimeKind.Local).AddTicks(188),
                            DepartmentId = "261e1685-cf26-494c-b17c-3546e65f5620",
                            Name = "Vincent Nys"
                        });
                });
