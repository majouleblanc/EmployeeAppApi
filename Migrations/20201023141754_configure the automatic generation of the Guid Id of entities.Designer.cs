...
namespace EmployeeAppApi.Migrations
{
    ...
    [Migration("20201023141754_configure the automatic generation of the Guid Id of entities")]
    partial class configuretheautomaticgenerationoftheGuidIdofentities
    {
            ...
            modelBuilder.Entity("EmployeeAppApi.Models.Employee", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateOfJoining = new DateTime(2020, 10, 23, 16, 17, 54, 246, DateTimeKind.Local).AddTicks(1002),
                        ...
                        new
                        {
                            ...
                            DateOfJoining = new DateTime(2020, 10, 23, 16, 17, 54, 249, DateTimeKind.Local).AddTicks(995),
                        ...
                        new
                        {
                            ...
                            DateOfJoining = new DateTime(2020, 10, 23, 16, 17, 54, 249, DateTimeKind.Local).AddTicks(1035),
                            DepartmentId = "261e1685-cf26-494c-b17c-3546e65f5620",
                            Name = "Vincent Nys"
                        });
                });
